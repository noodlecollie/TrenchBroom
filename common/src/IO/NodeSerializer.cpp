...
void NodeSerializer::defaultLayer(const Model::WorldNode& world) {
  ...
  // Transfer the color, locked state, and hidden state from the default layer Layer object to
  // worldspawn
...
void NodeSerializer::entity(
  ...
  const std::vector<Model::EntityProperty>& extraProperties, const Model::Node* brushParent) {
